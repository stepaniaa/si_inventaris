...
<div class="nav flex-column nav-pills mt-4 sidebar-dark" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <a class="nav-link {{ Request::is('staff_pengembalian_kapel') ? 'active' : '' }}" href="/staff_pengembalian_kapel">Daftar Pengembalian Kapel</a>
    <a class="nav-link {{ Request::is('staff_pengembalian_pkp') ? 'active' : '' }}" href="/staff_pengembalian_pkp">Daftar Pengembalian Perlengkapan</a>
</div>
